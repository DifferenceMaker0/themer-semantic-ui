...
const ToolbarDemo = () => ( 
	<Toolbar.Root
		className="flex w-full min-w-max rounded-md bg-white p-2.5 shadow-[0_2px_10px] shadow-black py-6"
		aria-label="Formatting options"
	>
		<Toolbar.ToggleGroup type="multiple" aria-label="Text formatting" style={{ marginLeft: "auto", marginRight: "auto" }}>
			<Toolbar.ToggleItem
		...
		<Toolbar.Button
			...
			style={{ marginLeft: "auto", marginRight: "auto" }}
		>
			 <i className="pr-[5px]"><ExternalLinkIcon /></i>
		</Toolbar.Button>
        </Toolbar.Root> 
);
