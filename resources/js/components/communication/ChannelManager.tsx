...
import { CommunicationChannel } from "@/entities/all";
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${channel.is_active ? 'bg-blue-100' : 'bg-slate-100'
                      }`}>
                      <ChannelIcon className={`w-6 h-6 ${channel.is_active ? 'text-blue-600' : 'text-slate-400'
                        }`} />
                    </div>
