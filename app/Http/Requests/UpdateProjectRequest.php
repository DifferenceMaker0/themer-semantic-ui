...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'project_type' => 'sometimes|required|in:web_design,web_development,mobile_app,content_writing,copywriting,seo,social_media,consulting,branding,ui_ux_design,e_commerce,maintenance,other',
        ...
        $validator->after(function ($validator) {
            ...
            if ($this->client_id) {
                ...
                if (!$client || $client->created_by !== auth()->user()->email) {
                    $validator->errors()->add(
                        'client_id',
                        'You can only assign projects to your own clients.'
                    );
                }
            }
        });
