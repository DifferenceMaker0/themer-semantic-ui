...
export default function VerifyEmail({ status }) {
    return (_jsxs(AuthLayout, { title: "Verify email", description: "Please verify your email address by clicking on the link we just emailed to you.", children: [_jsx(Head, { title: "Email verification" }), status === 'verification-link-sent' && (_jsx("div", { className: "mb-4 text-center text-sm font-medium text-green-600", children: "A new verification link has been sent to the email address you provided during registration." })), _jsx(Form, { ...EmailVerificationNotificationController.store.form(), className: "space-y-6 text-center", children: ({ processing }) => (_jsxs(_Fragment, { children: [_jsxs(Button, { disabled: processing, variant: "secondary", children: [processing && (_jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" })), "Resend verification email"] }), _jsx(TextLink, { href: logout(), className: "mx-auto block text-sm", children: "Log out" })] })) })] }));
}
